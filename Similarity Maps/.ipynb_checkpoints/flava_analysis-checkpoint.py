...
class FlavaCaptioningModel():
    def __init__(self, pretrained_model="facebook/flava-full", output_encoder_attentions=True, output_encoder_hidden_states=True) -> None:
    ...
    def model_initialization(self, pretrained_model, output_encoder_attentions=True, output_encoder_hidden_states=True):
        model = FlavaModel.from_pretrained(pretrained_model)
    ...
    def forward_pass(self, imgs:list):
        ...
        # in tests, model.config.output_attentions is not working.
